...
1.1. Run the service with the `AbstractAuditListener`

```bash
mvn clean install spring-boot:run
```

1.2. Run the service with the `AbstractAuthenticationAuditListener`
...
curl -H "Authorization: Bearer TOKEN" http://localhost:8081/actuator/auditevents
```
...
<div align="center">
      <a title="Nirvana - Aneurysm (Live At The Paramount, Seattle / 1991)" href="https://www.youtube.com/watch?v=aIr_IXXLZ8Q">
     <img 
          src="https://img.youtube.com/vi/aIr_IXXLZ8Q/0.jpg" 
          style="width:10%;">
      </a>
</div>
