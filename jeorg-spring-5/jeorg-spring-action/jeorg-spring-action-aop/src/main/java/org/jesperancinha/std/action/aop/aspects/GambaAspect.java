...
public class GambaAspect {
     ...
     */
    @Pointcut("execution(public * org.jesperancinha.std.action.aop.methods.GambaFoodCatcher.catchByHand()) || execution(public * org.jesperancinha.std.action.aop.methods.GambaFoodCatcher.*()) && within(@org.jesperancinha.std.action.aop.annotations.Master *))")
    public void beforeWithinNoAtAnnotation(){
    }

    @Before("beforeWithinNoAtAnnotation()")
    public void beforeWithinNoAtAnnotationHandler(){
        gambaService.beforeWithinNoAtAnnotation(null);
    }
