...
internal class GambaFoodCatcherKotlinTest @Autowired constructor(
    ...
    fun testCatchWithNetWhenCallingThenTriggerAllMatchingBeforeAdvices() {
        ...
        joinPointArgumentSlot.first().signature.toString() shouldBe "Gamba org.jesperancinha.std.action.aop.catchers.GambaFoodCatcher.catchWithNet()"
        verify {
    ...
    fun testCatchByHandWhenCallingThenTriggerAllMatchingBeforeAdvices() {
        ...
        joinPointArgumentSlot
            ...
            .apply {
                get(0).signature
                    .toString() shouldBe "Gamba org.jesperancinha.std.action.aop.catchers.GambaFoodCatcher.catchByHand()"
                get(1).signature
                    .toString() shouldBe "Gamba org.jesperancinha.std.action.aop.catchers.GambaFoodCatcher.catchByHand()"
                get(2).signature
                    .toString() shouldBe "Gamba org.jesperancinha.std.action.aop.catchers.GambaFoodCatcher.catchByHand()"
