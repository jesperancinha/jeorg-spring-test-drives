...
internal class BonitoCatcherKotlinTest @Autowired constructor(
    ...
    fun testCatchWithFishingPoleWhenCalledThenTriggerAllAdvices() {
        ...
        verify { bonito2Service.beforeAnyCatch(capture(joinPointArgumentSlot.also { it.clear() })) }
        joinPointArgumentSlot.first().signature.toString() shouldBe "Bonito org.jesperancinha.std.action.aop.catchers.BonitoCatcher.catchWithFishingPole()"
    }
    ...
    fun testCatchByHandWhenCalledThenTriggerAllAdvices() {
        ...
        verify { bonito2Service.beforeAnyCatch(capture(joinPointArgumentSlot.also { it.clear() })) }
        joinPointArgumentSlot.first().signature.toString() shouldBe "Bonito org.jesperancinha.std.action.aop.catchers.BonitoCatcher.catchByHand()"
    }
    ...
    fun testCatchByHandExtraWhenCalledThenTriggerAllAdvices() {
        ...
        verify { bonito2Service.beforeAnyCatch(capture(joinPointArgumentSlot.also { it.clear() })) }
        joinPointArgumentSlot.first().signature.toString() shouldBe "void org.jesperancinha.std.action.aop.catchers.BonitoCatcher.catchByHandExtra()"
    }
    ...
    fun testCatchWithSuperSonicWavesWhenCalledThenTriggerAllAdvices() {
        ...
        verify { bonito2Service.beforeAnyCatch(capture(joinPointArgumentSlot.also { it.clear() })) }
        joinPointArgumentSlot.first().signature.toString() shouldBe "Bonito org.jesperancinha.std.action.aop.catchers.BonitoCatcher.catchWithSuperSonicWaves()"
    }
    ...
    fun testCatchWithABucketWhenCalledThenTriggerAllAdvices() {
        ...
        verify { bonito2Service.beforeAnyCatch(capture(joinPointArgumentSlot.also { it.clear() })) }
        joinPointArgumentSlot.first().signature.toString() shouldBe "Bonito org.jesperancinha.std.action.aop.catchers.BonitoCatcher.catchWithABucket()"
    }
    ...
    fun testCatchWithLoveWhenCalledThenTriggerAllAdvices() {
        ...
        verify { bonito2Service.beforeAnyCatch(capture(joinPointArgumentSlot.also { it.clear() })) }
        joinPointArgumentSlot.first().signature.toString() shouldBe "Bonito org.jesperancinha.std.action.aop.catchers.BonitoCatcher.catchWithLove()"
    }
}